...
export function StatCard({
  ...
  return (
    <div className="bg-white p-4 rounded-[20px] flex items-center justify-between w-[220px] h-[150px]">
      {/* Left Side: Icon & Label */}
      <div className="flex flex-col justify-between h-full">
        <div className="p-2 bg-[#DC8404] rounded-full text-white w-fit">
          {icon}
        </div>
        <p className="text-gray-700 text-[12px] font-medium mt-4">{label}</p>
      </div>
